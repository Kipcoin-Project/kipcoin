...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 nites per kB (0.00001 KIPC). This is to prepare for dropping the minimum transaction fee to 0.1 nites per kB (0.0001 KIPC) in the next release.
