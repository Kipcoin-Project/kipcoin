# Support for Output Descriptors in Kipcoin Core

Since Kipcoin Core v0.17, there is support for Output Descriptors in the
...
on Kipcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Kipcoin Core wallets, a convenience function `combo` is
