...
"""Verify that starting kipcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kipcoin with -h for help text")
        ...
        self.log.info("Start kipcoin with -version for version information")
        ...
        self.log.info("Start kipcoind with -fakearg to make sure it does not start")
