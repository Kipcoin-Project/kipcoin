...
LITECOIND=${BITCOIND:-$BINDIR/kipcoind}
LITECOINCLI=${BITCOINCLI:-$BINDIR/kipcoin-cli}
LITECOINTX=${BITCOINTX:-$BINDIR/kipcoin-tx}
LITECOINQT=${BITCOINQT:-$BINDIR/qt/kipcoin-qt}
